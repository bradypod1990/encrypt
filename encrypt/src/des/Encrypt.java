...
public class Encrypt {
	...
	public static void main(String[] args) {
		...
		String enstr = Encrypt.strEncode(str, "apexsoft", "asdfghjklqwertyuiop1234567890", "zxcvbnmlkjhgfdsa");
		System.out.println(enstr);
		
		String destr = Encrypt.strDecode(enstr, "apexsoft", "asdfghjklqwertyuiop1234567890", "zxcvbnmlkjhgfdsa");
